...
(set-frame-font "Iosevka Term Semibold 18" nil t)
...
(setq org-todo-keywords
    ;'((sequence "NEXT" "TODO" "DOING" "|" "@" "WAITING" "DONE")))
    '((sequence "DEEP" "PC" "HOME" "ERRANDS" "69" "RELAX" "WAITING" "|" "DONE")))
...
(setq
  org-default-notes-file "~/Dropbox/Orgzly/gtd.org"
  initial-buffer-choice  org-default-notes-file)

;; Agenda files
(global-set-key (kbd "C-c a") 'org-agenda)
(global-set-key (kbd "C-c c") 'org-todo-list)
(setq org-agenda-files '("~/Dropbox/Orgzly/gtd.org"))
